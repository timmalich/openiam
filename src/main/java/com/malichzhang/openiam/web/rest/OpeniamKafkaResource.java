...
@RestController
@RequestMapping("/api/openiam-kafka")
public class OpeniamKafkaResource {

    private final Logger log = LoggerFactory.getLogger(OpeniamKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public OpeniamKafkaResource(KafkaProperties kafkaProperties) {
