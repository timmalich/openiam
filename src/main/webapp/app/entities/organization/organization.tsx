...
import { getSearchEntities, getEntities } from './organization.reducer';
  ...
  return (
    <div>
      <h2 id="organization-heading">
        <Translate contentKey="openiamApp.organization.home.title">Organizations</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="openiamApp.organization.home.createLabel">Create new Organization</Translate>
        </Link>
      </h2>
      <Row>
        <Col sm="12">
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('openiamApp.organization.home.search')}
                />
        ...
        {organizationList && organizationList.length > 0 ? (
            ...
            <tbody>
              {organizationList.map((organization, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <Translate contentKey={`openiamApp.Community.${organization.community}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="openiamApp.organization.home.notFound">No Organizations found</Translate>
            </div>
          )
        )}
      </div>
